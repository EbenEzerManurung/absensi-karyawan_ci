...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand  navbar-light" style="background-color: #026110">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #026110">
    <!-- Brand Logo -->
  ...
  <!-- /.content-wrapper -->
  <footer class="main-footer" style="background-color: #7d736a; color: white">
    <strong>Copyright &copy;<?=date('Y')?> <a href="#" style="color: white">Eben Nezer Manurung</a>.</strong>
    All rights reserved.
