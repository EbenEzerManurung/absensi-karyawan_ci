...
<body>
    <img class="wave" src="<?php echo base_url(); ?>assets/img/startup.jpg" background="transparent"  speed="1"  style="width: 700px; height: 900px;" > 
    <div class="container">
        <div class="img">
        </div>
        <div class="login-content">
            <form action="<?=base_url('auth/aksi_login')?>" method="post">
                <img src="<?php echo base_url(); ?>assets/img/karyawan.jpg">
                <br>
                ...
                <input type="submit" class="btn btn-primary" style="background-color: #f27501" value="Login">
            </form>
        </div>
    </div>
